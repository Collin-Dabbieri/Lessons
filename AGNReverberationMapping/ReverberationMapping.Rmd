...
WL_Hbeta=4861.4
sigma_Hbeta=1663 #km/s
#delta v=c delta log lambda
delta_log_lambda=(sigma_Hbeta/lightspeed)
sigma_Hbeta_wl=exp(delta_log_lambda)
A_Hbeta=5
norm_true=9
norm_WL=4840
alpha_true=1.85
...
coeff_nls=c(8.9905,-0.0539,1.0256,4.8840)
...
So our estimate of $\sigma$ is 1.02. For data that is evenly sampled in log($\lambda$)

$$\delta v =c \delta(log\lambda)$$

```{r}
sigma_v=3e8*log(1.02)
sigma_v
```
